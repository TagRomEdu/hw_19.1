        ...
        <main class="row">
            <div class="row text-center">
                ...
                <div class="col-sm-4 mb-sm-4">
                    <div class="card">
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">Воздух из Сочи</h4>
                        </div>
                        <div class="card-body">
                            <h2 class="card-title pricing-card-title">$10 000</h2>
                            <p>
                                Тот самый!
                                Заряжает энергией!
                                Есть вероятность, что на выдохе будет сочинский углекислый газ!
                            </p>
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">Контактные данные</h4>
                        </div>
                        <div class="card-body">
                            <form>
                              <div class="mb-3">
                ...
                <div class="col-sm-12 mb-sm-4">
                    <div class="card">
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">Часто задаваемые вопросы (FAQ)</h4>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card-body">
                        <table class="table">
                          ...
                          <tbody>
                            <tr>
                              <th scope="row">1</th>
                              <td>Воздух из Сочи</td>
                              <td>10 000</td>
                              <td>1</td>
                              <td>10 000</td>
                              <td><div class="alert alert-success" role="alert">Доставлен</div></td>
                            </tr>
                            <tr>
                              <th scope="row">2</th>
                              <td>Солнцебеззащитные очки</td>
                              <td>1 000</td>
                              <td>5</td>
                              <td>5 000</td>
                              <td><div class="alert alert-warning" role="alert">Передан в доставку</div></td>
                            </tr>
                            <tr>
                              <th scope="row">3</th>
                              <td>Антидождевик</td>
                              ...
                              <td>1</td>
                              <td>2 000</td>
                              <td><div class="alert alert-primary" role="alert">Сборка заказа</div></td>
                            </tr>
                            <tr>
                              <th scope="row">4</th>
                              <td>Самая-полезная-в-жизни-штука</td>
                              <td>1</td>
                              <td>1</td>
                              <td>1</td>
                              <td><div class="alert alert-danger" role="alert">Отменён</div></td>
                            </tr>
                          </tbody>
                        </table>
                    </div>
